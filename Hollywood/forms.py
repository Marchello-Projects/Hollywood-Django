...
class BookingForm(forms.ModelForm):
    class Meta:
        model = PatientRecord
        fields = ["full_name", "phone", "email", "visit_reason", "clinic_address"]
        widgets = {
            "full_name": forms.TextInput(attrs={"placeholder": "Іванов Іван Іванович"}),
            "phone": forms.TextInput(
                attrs={"type": "tel", "placeholder": "+380XXXXXXXXX"}
            ),
